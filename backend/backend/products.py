class products:
    def __init__(self, product_id=None, product_name=None, supplier_id=None, category_id=None, quantity_per_unit=None,
                 unit_price=None, units_in_stock=None, units_on_order=None, reorder_level=None, discontinued=None):
